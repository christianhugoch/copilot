...
class AnyActionSkill {
  ...
  async systemPrompt() {
    return (
      ...
      `Use a Workflow action with a single step of type "run_js_code" — do NOT use the send_email action, it will not work for verification. ` +
      `The run_js_code step must contain exactly:\n` +
